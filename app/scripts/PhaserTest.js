...
function create() {
    ...
    // Here we'll create 12 starts evenly spaced apart
    for (var i = 0; i < 12; i++) {
        ...
        star.body.bounce.x = 2 + Math.random() * 0.2;
    }
...
function update() {
    ...
    // Reset the player's velocity (movement restriction)
    ...
    // Allow player to jumpe if they are touching the ground.
